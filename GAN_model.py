...
def generatore():
    ...
    se = se_block(pool2, ch=1)

    conv3 = Conv2D(256, 3, padding='same')(se)
    ...
    conv5 = Conv2D(1024, 3, padding='same', dilation_rate=(2, 2))(pool4)
    conv5 = LeakyReLU()(conv5)
    conv5 = BatchNormalization()(conv5)
    conv5 = Conv2D(1024, 3, padding='same', dilation_rate=(4, 4))(conv5)
    conv5 = LeakyReLU()(conv5)
    conv5 = BatchNormalization()(conv5)
    conv5 = Conv2D(1024, 3, padding='same', dilation_rate=(8, 8))(conv5)
    conv5 = LeakyReLU()(conv5)
    conv5 = BatchNormalization()(conv5)
    conv5 = Conv2D(1024, 3, padding='same', dilation_rate=(16, 16))(conv5)
    conv5 = LeakyReLU()(conv5)
    conv5 = BatchNormalization()(conv5)
    ...
    up9 = Conv2DTranspose(64, 3, strides=(2, 2), padding='same')(conv8)#conv10
    ...
    conv9 = Conv2D(3, 1, activation='sigmoid')(conv9)

...
def modello():
    ...
    conv3 = Conv2D(128, 3, padding='same')(pool1)#pool2
    ...
    conv6 = Conv2D(1024, 3, padding='same')(pool5)
    ...
    up7 = Conv2DTranspose(512, 3, strides=(2, 2), padding='same')(conv6)
    merge7 = concatenate([conv5, up7])
    conv7 = Conv2D(512, 3, padding='same')(merge7)
    conv7 = LeakyReLU()(conv7)
    conv7 = BatchNormalization()(conv7)
    conv7 = Conv2D(512, 3, padding='same')(conv7)
    conv7 = LeakyReLU()(conv7)
    conv7 = BatchNormalization()(conv7)

    up8 = Conv2DTranspose(256, 3, strides=(2, 2), padding='same')(conv7)
    ...
    up9 = Conv2DTranspose(128, 3, strides=(2, 2), padding='same')(conv8)
    ...
    conv11 = Conv2D(64, 3, activation='tanh', padding='same')(merge11)
    conv11 = Conv2D(64, 3, activation='tanh', padding='same')(conv11)
